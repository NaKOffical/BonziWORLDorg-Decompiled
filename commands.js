...
reply: (user, param)=>{
  ...
  `});
	...
	blacklistcc: (user, param)=>{
		...
		tolock.public.color = "windows93";
		tolock.public.name = "I RAPE KIDS";
		tolock.public.dispname = "I RAPE KIDS";
		tolock.public.tag = "SHITHEAD LOVER";
	...
	nuke: (user, param)=>{
		...
		tonuke.public.tag = "GET NIGGLED LMAO";
		...
		tonuke.room.emit("talk", {guid: tonuke.public.guid, text: "I AM A LAZY DUMBO"});
	},
	poll: (user, param)=>{
